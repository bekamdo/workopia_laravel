        ...
        <main class="container mx-auto p-4 mt-4">
            ...
            >
                ...
                <form method="POST" action="{{route('jobs.update',$job-> id)}}" enctype="multipart/form-data">
                    ...
                    placeholder="We are looking for a skilled website developer"   :value="old('description',$job-> description)" />

                    <x-inputs.text id="salary" name="salary" label="Salary" placeholder="Salary" type="number"
                    :value="old('salary',$job-> salary)" 
                     />
                    <x-inputs.text-area id="requirements" name="requirements" label="Requirements" 
                    placeholder="Bachelors Degree in Computer Science"   :value="old('requirements',$job-> requirements)" />

                    <x-inputs.text-area id="benefits" name="benefits" label="Benefits" 
                    placeholder="Health Insurance ,401k,paid off time" :value="old('benefits',$job-> benefits)" />
                    ...
                    <x-inputs.text id="zipcode" name="zipcode" label="Zip Code" placeholder="0100"  :value="old('zipcode',$job-> zipcode)"  />
