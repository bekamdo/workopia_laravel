        ...
        <main class="container mx-auto p-4 mt-4">
            ...
            >
                ...
                @csrf
                    ...
                    placeholder="We are looking for a skilled website developer"/>
                    ...
                    placeholder="Health Insurance ,401k,paid off time"/>
                    ...
                    <x-inputs.text id="zipcode" name="zipcode" label="Zip Code" placeholder="0100" />
                    ...
                    <x-inputs.text id="company_website" name="company_website" type="url" label="Company Website" placeholder="Enter Company Website" />
