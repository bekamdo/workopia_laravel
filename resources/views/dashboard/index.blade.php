    ...
    <section class="flex flex-col md:flex-row gap-4">
        ...
        <div class="bg-white p-8 rounded-lg shadow-md w-full">
            ...
            <form method="POST" action="{{route('profile.update')}}" enctype="multipart/form-data">
                ...
                <button type="submit" class="w-full px-4 py-2 bg-green-500 hover:bg-green-600 
                focus:outline-none text-white">Save</button>
    ...
    <div class="flex justify-between items-center border-b-2 border-gray-200 py-2">
        ...
        <div class="flex space-x-3">
            <a href="{{route('jobs.edit',$job -> id)}}" class="bg-blue-500 text-white px-4 py-2 rounded text-sm">
              ...
              <!-- Delete Form -->
              <form method="POST" action="{{route('jobs.destroy',$job -> id)}}?from=dashboard" onsubmit="return 
...
>
  ...
  <button type="submit" class="text-red-500 hover:text-red-700 text-sm">
    ...
    @empty
    <p class="text-gray-700">You Have no Jobs Listings</p>
